    ...
    return (
        <div className='h-screen sticky top-0 flex flex-col justify-between pt-2 pb-8'>
            ...
            <div className='flex flex-col gap-4 text-lg items-center xxl:items-center'>
                ...
                {/* Button */}
                <Link href="/" className='bg-white text-black rounded-full font-bold py-2 px-20 w-12 h-12 flex justify-center xxl:hidden'>
                    <Image src="/icons/post.svg" alt='' height={24} width={24}/>
                </Link>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2'>
                    <div className='relative w-10 h-10 rounded-full overflow-hidden'>
                        <Image src="/general/avatar.png" alt='kandyhamisi' fill/>
                    </div>
